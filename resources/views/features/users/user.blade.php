...
<div class="content-wrapper" style="min-height: 2646.44px;">
                        ...
                        <div class="card-body box-profile">
                            ...
                            <ul class="list-group list-group-unbordered mb-3">
                                ...
                                <li class="list-group-item">
                                    <b>Signature</b>
                                    <a class="float-right">
                                    <form action="/user/updatesignature" method="post" id="form-signature" enctype="multipart/form-data">
                                        @csrf
                                        <input type="hidden" name="user_id" value="{{$user->id}}">
                                        <div class="d-none">
                                            <input type="file" name="signature" id="signature" accept="image/png, image/jpg, image/jpeg" onchange="uploadSign()">
                                        </div>
                                        <button class="btn btn-warning" type="button" name="action" value="Activate User" onclick="openSignature()">Update Signature</button>
                                    </form>
                                    </a>
                                </li>
    ...
    <!-- /.content -->
    @include('features.users.modals.user_permission_modal')
</div>
<script>
