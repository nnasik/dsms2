    ...
    <body>
        ...
        <table style="width: 100%;" class="border" cellspacing="0">
            <tr>
                ...
                <th style="width: 15%">Phone / WhatsApp</th>
                <th style="width: 15%">Department / Branch / Society / Committee</th>
                <th style="width: 05%">Arrival Time</th>
                <th style="width: 10%">Signature</th>
                <th style="width: 05%">Departure Time</th>
                <th style="width: 10%">Signature</th>
            </tr>
