...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('mails', function (Blueprint $table) {
            ...
            $table->mediumText('note_to_assigned_officer')->nullable();

            $table->string('subject_officer')->nullable();
            $table->datetime('subject_officer_on')->nullable();
            ...
            $table->mediumText('note_to_subject_officer')->nullable();

            $table->string('reply_document_1')->nullable();
            $table->string('reply_document_2')->nullable();
            $table->mediumText('reply_note')->nullable();
        ...
        Schema::table('mails', function (Blueprint $table){
            ...
            $table->foreign('subject_officer')->references('id')->on('users');
        });
    }
